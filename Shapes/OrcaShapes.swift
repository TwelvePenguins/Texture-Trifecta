...
struct OrcaBody: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        path.closeSubpath()
        path.move(to: CGPoint(x: 0.37687*width, y: 0.42458*height))
        path.addCurve(to: CGPoint(x: 0.09552*width, y: 0.50558*height), control1: CGPoint(x: 0.28209*width, y: 0.45651*height), control2: CGPoint(x: 0.15299*width, y: 0.41368*height))
        ...
        path.addCurve(to: CGPoint(x: 0.31567*width, y: 0.57645*height), control1: CGPoint(x: 0.30896*width, y: 0.7548*height), control2: CGPoint(x: 0.32388*width, y: 0.64421*height))
        path.addCurve(to: CGPoint(x: 0.4694*width, y: 0.53128*height), control1: CGPoint(x: 0.31642*width, y: 0.59592*height), control2: CGPoint(x: 0.48209*width, y: 0.6224*height))
        ...
        path.addCurve(to: CGPoint(x: 0.7209*width, y: 0.57334*height), control1: CGPoint(x: 0.68184*width, y: 0.56243*height), control2: CGPoint(x: 0.70896*width, y: 0.56399*height))
        path.addCurve(to: CGPoint(x: 0.8194*width, y: 0.56633*height), control1: CGPoint(x: 0.74876*width, y: 0.56581*height), control2: CGPoint(x: 0.80746*width, y: 0.55387*height))
        path.addCurve(to: CGPoint(x: 0.90299*width, y: 0.63798*height), control1: CGPoint(x: 0.84776*width, y: 0.62007*height), control2: CGPoint(x: 0.86642*width, y: 0.64343*height))
        path.addCurve(to: CGPoint(x: 0.88657*width, y: 0.53595*height), control1: CGPoint(x: 0.8806*width, y: 0.58346*height), control2: CGPoint(x: 0.90672*width, y: 0.54919*height))
        path.addCurve(to: CGPoint(x: 0.89179*width, y: 0.46586*height), control1: CGPoint(x: 0.89179*width, y: 0.51181*height), control2: CGPoint(x: 0.87015*width, y: 0.47832*height))
        path.addCurve(to: CGPoint(x: 0.8194*width, y: 0.50869*height), control1: CGPoint(x: 0.86552*width, y: 0.45464*height), control2: CGPoint(x: 0.83259*width, y: 0.49*height))
        path.addCurve(to: CGPoint(x: 0.58582*width, y: 0.44795*height), control1: CGPoint(x: 0.73881*width, y: 0.4791*height), control2: CGPoint(x: 0.71716*width, y: 0.50636*height))
        path.addCurve(to: CGPoint(x: 0.47164*width, y: 0.42445*height), control1: CGPoint(x: 0.5602*width, y: 0.43834*height), control2: CGPoint(x: 0.50328*width, y: 0.42009*height))
        path.addCurve(to: CGPoint(x: 0.46269*width, y: 0.33112*height), control1: CGPoint(x: 0.44552*width, y: 0.41121*height), control2: CGPoint(x: 0.45622*width, y: 0.36461*height))
        path.addCurve(to: CGPoint(x: 0.37687*width, y: 0.42458*height), control1: CGPoint(x: 0.4097*width, y: 0.31944*height), control2: CGPoint(x: 0.39627*width, y: 0.42458*height))
        path.closeSubpath()
        return path
    }
}
...
struct OrcaBelly: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        path.closeSubpath()
        path.move(to: CGPoint(x: 0.09552*width, y: 0.50558*height))
        path.addCurve(to: CGPoint(x: 0.25*width, y: 0.60748*height), control1: CGPoint(x: 0.10597*width, y: 0.52842*height), control2: CGPoint(x: 0.18552*width, y: 0.59003*height))
        path.addLine(to: CGPoint(x: 0.2291*width, y: 0.5601*height))
        path.addCurve(to: CGPoint(x: 0.20149*width, y: 0.53517*height), control1: CGPoint(x: 0.2291*width, y: 0.54114*height), control2: CGPoint(x: 0.21418*width, y: 0.52739*height))
        path.addCurve(to: CGPoint(x: 0.14701*width, y: 0.50869*height), control1: CGPoint(x: 0.17782*width, y: 0.5497*height), control2: CGPoint(x: 0.16567*width, y: 0.53673*height))
        path.addCurve(to: CGPoint(x: 0.09552*width, y: 0.50558*height), control1: CGPoint(x: 0.13866*width, y: 0.51493*height), control2: CGPoint(x: 0.1092*width, y: 0.50921*height))
        path.closeSubpath()
        path.move(to: CGPoint(x: 0.31716*width, y: 0.6215*height))
        path.addCurve(to: CGPoint(x: 0.72015*width, y: 0.57334*height), control1: CGPoint(x: 0.41269*width, y: 0.64486*height), control2: CGPoint(x: 0.59627*width, y: 0.61773*height))
        path.addCurve(to: CGPoint(x: 0.6709*width, y: 0.56633*height), control1: CGPoint(x: 0.70821*width, y: 0.56399*height), control2: CGPoint(x: 0.68184*width, y: 0.56243*height))
        path.addCurve(to: CGPoint(x: 0.66119*width, y: 0.5453*height), control1: CGPoint(x: 0.54179*width, y: 0.63019*height), control2: CGPoint(x: 0.54104*width, y: 0.55776*height))
        path.addCurve(to: CGPoint(x: 0.6709*width, y: 0.53128*height), control1: CGPoint(x: 0.6803*width, y: 0.53969*height), control2: CGPoint(x: 0.67562*width, y: 0.53362*height))
        path.addCurve(to: CGPoint(x: 0.4694*width, y: 0.53128*height), control1: CGPoint(x: 0.5097*width, y: 0.49514*height), control2: CGPoint(x: 0.4694*width, y: 0.51493*height))
        path.addCurve(to: CGPoint(x: 0.31493*width, y: 0.57723*height), control1: CGPoint(x: 0.48209*width, y: 0.6224*height), control2: CGPoint(x: 0.31567*width, y: 0.5967*height))
        path.addCurve(to: CGPoint(x: 0.31716*width, y: 0.6215*height), control1: CGPoint(x: 0.31567*width, y: 0.57978*height), control2: CGPoint(x: 0.31716*width, y: 0.59221*height))
        path.closeSubpath()
        return path
    }
}
